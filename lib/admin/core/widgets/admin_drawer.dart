...
class AdminDrawer extends StatelessWidget {
  ...
  static const List<AdminNavEntry> entries = [
    ...
    // These four are siblings behind one tab strip. They were reachable only
    // from inside the Inventory screen, so an operator had to know the tabs
    // existed before they could find them.
    AdminNavEntry(
      ...
      children: [
        AdminNavEntry(AdminRoutes.INVENTORY, 'Overview',
            Icons.dashboard_outlined, permission: 'inventory.read'),
        AdminNavEntry(AdminRoutes.INVENTORY_MOVEMENTS, 'Movements',
    ...
    AdminNavEntry(
      ...
      children: [
        AdminNavEntry(AdminRoutes.STAFF, 'Operators',
            Icons.people_outline_rounded, permission: 'staff.read'),
        AdminNavEntry(AdminRoutes.ROLES, 'Roles and permissions',
