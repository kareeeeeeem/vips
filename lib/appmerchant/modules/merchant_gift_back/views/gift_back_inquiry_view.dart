...
class GiftBackInquiryView extends GetView<MerchantGiftBackController> {
        ...
        children: [
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  // Header Card - Orange Gradient style
                  Container(
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: Center(child: Icon(Icons.restaurant, color: Colors.white, size: 32.sp)),
                      ),
                      SizedBox(width: 16.w),
                      Expanded(
                        child: Column(
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: Center(child: Icon(Icons.remove, color: const Color(0xFF10B981), size: 20.sp)),
                        ),
                        SizedBox(width: 16.w),
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: ElevatedButton(
                    onPressed: () => controller.onProceedToPin(),
  ...
  Widget _buildAmountRow(String label, String value, {bool isVip = false}) {
    return Padding(
      padding: EdgeInsets.only(bottom: 8.h),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Text(label, style: TextStyle(fontSize: 14.sp, color: isVip ? const Color(0xFF9CA3AF) : const Color(0xFF4B5563), fontWeight: isVip ? FontWeight.w700 : FontWeight.w500)),
          Text(value, style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w700, color: isVip ? const Color(0xFF9CA3AF) : const Color(0xFF1F2937))),
        ],
      ),
    );
  }
