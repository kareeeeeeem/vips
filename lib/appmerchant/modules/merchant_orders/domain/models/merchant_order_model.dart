...
class PaginatedMerchantOrderModel {
  int? totalSize;
  String? limit;
  String? offset;
  List<MerchantOrder>? orders;

  PaginatedMerchantOrderModel({
    this.totalSize,
    this.limit,
    this.offset,
    this.orders,
  ...
  PaginatedMerchantOrderModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['orders'] != null) {
      ...
      json['orders'].forEach((v) {
        orders!.add(MerchantOrder.fromJson(v));
      });
    }
  }
...
class MerchantOrder {
  ...
  String? refunded;
  MerchantDeliveryAddress? deliveryAddress;
  int? scheduled;
  ...
  double? dmTips;
  int? processingTime;
  MerchantDeliveryMan? deliveryMan;
  bool? taxStatus;
  bool? cutlery;
  String? unavailableItemNote;
  String? deliveryInstruction;
  List<String>? orderProofFullUrl;
  List<MerchantPayments>? payments;
  ...
  MerchantOrder.fromJson(Map<String, dynamic> json) {
    ...
    deliveryAddress =
        json['delivery_address'] != null
            ? MerchantDeliveryAddress.fromJson(json['delivery_address'])
            : null;
    ...
    customer =
        json['customer'] != null
            ? MerchantCustomer.fromJson(json['customer'])
            : null;
    ...
    if (json['payments'] != null) {
      ...
      json['payments'].forEach((v) {
        payments!.add(MerchantPayments.fromJson(v));
      });
    }
...
class MerchantDeliveryMan {
  ...
  MerchantDeliveryMan.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    fName = json['f_name'];
    lName = json['l_name'];
    phone = json['phone'];
...
class MerchantDeliveryAddress {
  ...
  MerchantDeliveryAddress.fromJson(Map<String, dynamic> json) {
...
class MerchantPayments {
  ...
  MerchantPayments.fromJson(Map<String, dynamic> json) {
    id = json['id'];
